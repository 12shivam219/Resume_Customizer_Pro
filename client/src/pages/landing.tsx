...
import { FileText, Edit, Download, Users, Star, ArrowRight } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <h4 className="text-xl font-semibold text-foreground mb-2">DOCX Upload & Editing</h4>
                <p className="text-muted-foreground">
                  Upload your existing resume and edit it with our powerful rich-text editor.
            ...
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <h4 className="text-xl font-semibold text-foreground mb-2">Smart Tech Stack Processing</h4>
                <p className="text-muted-foreground">
                  Organize your technical skills and bullet points into strategic groups
            ...
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <h4 className="text-xl font-semibold text-foreground mb-2">Export & Cloud Storage</h4>
                <p className="text-muted-foreground">
                  Download as DOCX/PDF or save directly to Google Drive.
                  Access your resumes anywhere.
                </p>
              </CardContent>
            </Card>
          </div>
